///Register `PB0%sPFS` reader
pub type R = crate::R<Pb0pfsSpec>;
///Register `PB0%sPFS` writer
pub type W = crate::W<Pb0pfsSpec>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<Pb0pfsSpec> {
        PodrW::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<Pb0pfsSpec> {
        PdrW::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<Pb0pfsSpec> {
        PcrW::new(self, 4)
    }
    ///Bit 6 - N-Channel Open-Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<Pb0pfsSpec> {
        NcodrW::new(self, 6)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<Pb0pfsSpec> {
        IselW::new(self, 14)
    }
    ///Bit 15 - Analog Input Enable
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<Pb0pfsSpec> {
        AselW::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<Pb0pfsSpec> {
        PmrW::new(self, 16)
    }
    ///Bits 24:28 - Peripheral Select
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<Pb0pfsSpec> {
        PselW::new(self, 24)
    }
}
/**Port B0%s Pin Function Select Register

You can [`read`](crate::Reg::read) this register and get [`pb0pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pb0pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Pb0pfsSpec;
impl crate::RegisterSpec for Pb0pfsSpec {
    type Ux = u32;
}
///`read()` method returns [`pb0pfs::R`](R) reader structure
impl crate::Readable for Pb0pfsSpec {}
///`write(|w| ..)` method takes [`pb0pfs::W`](W) writer structure
impl crate::Writable for Pb0pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PB0%sPFS to value 0
impl crate::Resettable for Pb0pfsSpec {}
