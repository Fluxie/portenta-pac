///Register `P10%sPFS` reader
pub type R = crate::R<P10pfsSpec>;
///Register `P10%sPFS` writer
...
///`read()` method returns [`p10pfs::R`](R) reader structure
impl crate::Readable for P10pfsSpec {}
///`write(|w| ..)` method takes [`p10pfs::W`](W) writer structure
impl crate::Writable for P10pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P10%sPFS to value 0
