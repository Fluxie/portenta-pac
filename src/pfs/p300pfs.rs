///Register `P300PFS` reader
pub type R = crate::R<P300pfsSpec>;
///Register `P300PFS` writer
...
///`read()` method returns [`p300pfs::R`](R) reader structure
impl crate::Readable for P300pfsSpec {}
///`write(|w| ..)` method takes [`p300pfs::W`](W) writer structure
impl crate::Writable for P300pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P300PFS to value 0x0001_0010
