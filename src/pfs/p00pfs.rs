///Register `P00%sPFS` reader
pub type R = crate::R<P00pfsSpec>;
///Register `P00%sPFS` writer
...
///`read()` method returns [`p00pfs::R`](R) reader structure
impl crate::Readable for P00pfsSpec {}
///`write(|w| ..)` method takes [`p00pfs::W`](W) writer structure
impl crate::Writable for P00pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P00%sPFS to value 0
