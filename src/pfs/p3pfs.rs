///Register `P3%sPFS` reader
pub type R = crate::R<P3pfsSpec>;
///Register `P3%sPFS` writer
pub type W = crate::W<P3pfsSpec>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P3pfsSpec> {
        PodrW::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P3pfsSpec> {
        PdrW::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P3pfsSpec> {
        PcrW::new(self, 4)
    }
    ///Bit 6 - N-Channel Open-Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P3pfsSpec> {
        NcodrW::new(self, 6)
    }
    ///Bits 12:13 - Event on Falling/Event on Rising
    #[inline(always)]
    pub fn eofr(&mut self) -> EofrW<P3pfsSpec> {
        EofrW::new(self, 12)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P3pfsSpec> {
        IselW::new(self, 14)
    }
    ///Bit 15 - Analog Input Enable
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P3pfsSpec> {
        AselW::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P3pfsSpec> {
        PmrW::new(self, 16)
    }
    ///Bits 24:28 - Peripheral Select
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P3pfsSpec> {
        PselW::new(self, 24)
    }
}
/**Port 3%s Pin Function Select Register

You can [`read`](crate::Reg::read) this register and get [`p3pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p3pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct P3pfsSpec;
impl crate::RegisterSpec for P3pfsSpec {
    type Ux = u32;
}
///`read()` method returns [`p3pfs::R`](R) reader structure
impl crate::Readable for P3pfsSpec {}
///`write(|w| ..)` method takes [`p3pfs::W`](W) writer structure
impl crate::Writable for P3pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P3%sPFS to value 0
impl crate::Resettable for P3pfsSpec {}
