///Register `P80%sPFS` reader
pub type R = crate::R<P80pfsSpec>;
///Register `P80%sPFS` writer
pub type W = crate::W<P80pfsSpec>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P80pfsSpec> {
        PodrW::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P80pfsSpec> {
        PdrW::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P80pfsSpec> {
        PcrW::new(self, 4)
    }
    ///Bit 6 - N-Channel Open-Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P80pfsSpec> {
        NcodrW::new(self, 6)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P80pfsSpec> {
        IselW::new(self, 14)
    }
    ///Bit 15 - Analog Input Enable
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P80pfsSpec> {
        AselW::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P80pfsSpec> {
        PmrW::new(self, 16)
    }
    ///Bits 24:28 - Peripheral Select
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P80pfsSpec> {
        PselW::new(self, 24)
    }
}
/**Port 80%s Pin Function Select Register

You can [`read`](crate::Reg::read) this register and get [`p80pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p80pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct P80pfsSpec;
impl crate::RegisterSpec for P80pfsSpec {
    type Ux = u32;
}
///`read()` method returns [`p80pfs::R`](R) reader structure
impl crate::Readable for P80pfsSpec {}
///`write(|w| ..)` method takes [`p80pfs::W`](W) writer structure
impl crate::Writable for P80pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P80%sPFS to value 0
impl crate::Resettable for P80pfsSpec {}
