///Register `P1%sPFS` reader
pub type R = crate::R<P1pfsSpec>;
///Register `P1%sPFS` writer
...
///`read()` method returns [`p1pfs::R`](R) reader structure
impl crate::Readable for P1pfsSpec {}
///`write(|w| ..)` method takes [`p1pfs::W`](W) writer structure
impl crate::Writable for P1pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P1%sPFS to value 0
