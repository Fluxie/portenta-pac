///Register `P20%sPFS` reader
pub type R = crate::R<P20pfsSpec>;
///Register `P20%sPFS` writer
...
///`read()` method returns [`p20pfs::R`](R) reader structure
impl crate::Readable for P20pfsSpec {}
///`write(|w| ..)` method takes [`p20pfs::W`](W) writer structure
impl crate::Writable for P20pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P20%sPFS to value 0
