///Register `PA10PFS` reader
pub type R = crate::R<Pa10pfsSpec>;
///Register `PA10PFS` writer
pub type W = crate::W<Pa10pfsSpec>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<Pa10pfsSpec> {
        PodrW::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<Pa10pfsSpec> {
        PdrW::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<Pa10pfsSpec> {
        PcrW::new(self, 4)
    }
    ///Bit 6 - N-Channel Open-Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<Pa10pfsSpec> {
        NcodrW::new(self, 6)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<Pa10pfsSpec> {
        IselW::new(self, 14)
    }
    ///Bit 15 - Analog Input Enable
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<Pa10pfsSpec> {
        AselW::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<Pa10pfsSpec> {
        PmrW::new(self, 16)
    }
    ///Bits 24:28 - Peripheral Select
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<Pa10pfsSpec> {
        PselW::new(self, 24)
    }
}
/**Port A10 Pin Function Select Register

You can [`read`](crate::Reg::read) this register and get [`pa10pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pa10pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Pa10pfsSpec;
impl crate::RegisterSpec for Pa10pfsSpec {
    type Ux = u32;
}
///`read()` method returns [`pa10pfs::R`](R) reader structure
impl crate::Readable for Pa10pfsSpec {}
///`write(|w| ..)` method takes [`pa10pfs::W`](W) writer structure
impl crate::Writable for Pa10pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PA10PFS to value 0
impl crate::Resettable for Pa10pfsSpec {}
