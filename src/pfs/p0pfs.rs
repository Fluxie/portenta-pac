///Register `P0%sPFS` reader
pub type R = crate::R<P0pfsSpec>;
///Register `P0%sPFS` writer
...
///`read()` method returns [`p0pfs::R`](R) reader structure
impl crate::Readable for P0pfsSpec {}
///`write(|w| ..)` method takes [`p0pfs::W`](W) writer structure
impl crate::Writable for P0pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P0%sPFS to value 0
