///Register `P008PFS` reader
pub type R = crate::R<P008pfsSpec>;
///Register `P008PFS` writer
pub type W = crate::W<P008pfsSpec>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P008pfsSpec> {
        PodrW::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P008pfsSpec> {
        PdrW::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P008pfsSpec> {
        PcrW::new(self, 4)
    }
    ///Bit 6 - N-Channel Open-Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P008pfsSpec> {
        NcodrW::new(self, 6)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P008pfsSpec> {
        IselW::new(self, 14)
    }
    ///Bit 15 - Analog Input Enable
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P008pfsSpec> {
        AselW::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P008pfsSpec> {
        PmrW::new(self, 16)
    }
    ///Bits 24:28 - Peripheral Select
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P008pfsSpec> {
        PselW::new(self, 24)
    }
}
/**Port 008 Pin Function Select Register

You can [`read`](crate::Reg::read) this register and get [`p008pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p008pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct P008pfsSpec;
impl crate::RegisterSpec for P008pfsSpec {
    type Ux = u32;
}
///`read()` method returns [`p008pfs::R`](R) reader structure
impl crate::Readable for P008pfsSpec {}
///`write(|w| ..)` method takes [`p008pfs::W`](W) writer structure
impl crate::Writable for P008pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P008PFS to value 0x0001_0410
impl crate::Resettable for P008pfsSpec {
    const RESET_VALUE: u32 = 0x0001_0410;
}
