...
///`read()` method returns [`p30pfs::R`](R) reader structure
impl crate::Readable for P30pfsSpec {}
///`write(|w| ..)` method takes [`p30pfs::W`](W) writer structure
impl crate::Writable for P30pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P30%sPFS to value 0
