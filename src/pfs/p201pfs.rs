///Register `P201PFS` reader
pub type R = crate::R<P201pfsSpec>;
///Register `P201PFS` writer
...
impl W {
    ...
    ///Bits 12:13 - Event on Falling/Event on Rising
    #[inline(always)]
    pub fn eofr(&mut self) -> EofrW<P201pfsSpec> {
        EofrW::new(self, 12)
    }
    ///Bit 14 - IRQ Input Enable
    #[inline(always)]
...
///`read()` method returns [`p201pfs::R`](R) reader structure
impl crate::Readable for P201pfsSpec {}
///`write(|w| ..)` method takes [`p201pfs::W`](W) writer structure
impl crate::Writable for P201pfsSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P201PFS to value 0x10
