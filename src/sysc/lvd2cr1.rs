///Register `LVD2CR1` reader
pub type R = crate::R<Lvd2cr1Spec>;
///Register `LVD2CR1` writer
...
///Field `IDTSEL` reader - Voltage Monitor 2 Interrupt Generation Condition Select
...
///Field `IDTSEL` writer - Voltage Monitor 2 Interrupt Generation Condition Select
...
///Field `IRQSEL` reader - Voltage Monitor 2 Interrupt Type Select
...
///Field `IRQSEL` writer - Voltage Monitor 2 Interrupt Type Select
...
impl R {
    ///Bits 0:1 - Voltage Monitor 2 Interrupt Generation Condition Select
    #[inline(always)]
    pub fn idtsel(&self) -> IdtselR {
        IdtselR::new(self.bits & 3)
    }
    ///Bit 2 - Voltage Monitor 2 Interrupt Type Select
    #[inline(always)]
...
///`read()` method returns [`lvd2cr1::R`](R) reader structure
impl crate::Readable for Lvd2cr1Spec {}
///`write(|w| ..)` method takes [`lvd2cr1::W`](W) writer structure
