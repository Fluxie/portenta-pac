///Register `LVD2CR0` reader
pub type R = crate::R<Lvd2cr0Spec>;
///Register `LVD2CR0` writer
...
///Field `RIE` reader - Voltage Monitor 2 Interrupt/Reset Enable
...
///Field `RIE` writer - Voltage Monitor 2 Interrupt/Reset Enable
...
///Field `DFDIS` reader - Voltage monitor 2 Digital Filter Disabled Mode Select
...
///Field `DFDIS` writer - Voltage monitor 2 Digital Filter Disabled Mode Select
...
///Field `CMPE` reader - Voltage Monitor 2 Circuit Comparison Result Output Enable
...
///Field `CMPE` writer - Voltage Monitor 2 Circuit Comparison Result Output Enable
...
///Field `RI` reader - Voltage Monitor 2 Circuit Mode Select
...
///Field `RI` writer - Voltage Monitor 2 Circuit Mode Select
...
///Field `RN` reader - Voltage Monitor 2 Reset Negate Select
...
///Field `RN` writer - Voltage Monitor 2 Reset Negate Select
...
impl R {
    ///Bit 0 - Voltage Monitor 2 Interrupt/Reset Enable
    #[inline(always)]
    pub fn rie(&self) -> RieR {
        RieR::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Voltage monitor 2 Digital Filter Disabled Mode Select
    #[inline(always)]
    pub fn dfdis(&self) -> DfdisR {
        DfdisR::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Voltage Monitor 2 Circuit Comparison Result Output Enable
    #[inline(always)]
    ...
    ///Bit 6 - Voltage Monitor 2 Circuit Mode Select
    #[inline(always)]
    pub fn ri(&self) -> RiR {
        RiR::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Voltage Monitor 2 Reset Negate Select
    #[inline(always)]
    pub fn rn(&self) -> RnR {
...
impl W {
    ...
    ///Bit 1 - Voltage monitor 2 Digital Filter Disabled Mode Select
    #[inline(always)]
    pub fn dfdis(&mut self) -> DfdisW<Lvd2cr0Spec> {
        DfdisW::new(self, 1)
    }
    ///Bit 2 - Voltage Monitor 2 Circuit Comparison Result Output Enable
    #[inline(always)]
    ...
    ///Bits 4:5 - Sampling Clock Select
    #[inline(always)]
    pub fn fsamp(&mut self) -> FsampW<Lvd2cr0Spec> {
        FsampW::new(self, 4)
    }
    ///Bit 6 - Voltage Monitor 2 Circuit Mode Select
    #[inline(always)]
...
///`read()` method returns [`lvd2cr0::R`](R) reader structure
impl crate::Readable for Lvd2cr0Spec {}
///`write(|w| ..)` method takes [`lvd2cr0::W`](W) writer structure
impl crate::Writable for Lvd2cr0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets LVD2CR0 to value 0x82
