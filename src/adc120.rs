...
impl RegisterBlock {
    ...
    ///0x20..0x36 - A/D Data Registers %s
    #[inline(always)]
    ...
    ///0x38 - A/D Data Registers 12
    #[inline(always)]
    pub const fn addr12(&self) -> &Addr {
        &self.addr12
    }
    ///0x38 - A/D Data Registers 13
    #[inline(always)]
    pub const fn addr13(&self) -> &Addr {
        &self.addr13
    }
    ...
    ///0xe0..0xeb - A/D Sampling State Register
    #[inline(always)]
    ...
    ///0xec - A/D Sampling State Register
    #[inline(always)]
    pub const fn adsstr12(&self) -> &Adsstr {
        &self.adsstr12
    }
    ///0xec - A/D Sampling State Register
    #[inline(always)]
    pub const fn adsstr13(&self) -> &Adsstr {
        &self.adsstr13
    }
}
