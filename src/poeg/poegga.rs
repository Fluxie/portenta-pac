///Register `POEGGA` reader
pub type R = crate::R<PoeggaSpec>;
///Register `POEGGA` writer
pub type W = crate::W<PoeggaSpec>;
...
impl W {
    ///Bit 0 - Port Input Detection Flag
    #[inline(always)]
    pub fn pidf(&mut self) -> PidfW<PoeggaSpec> {
        PidfW::new(self, 0)
    }
    ///Bit 1 - Detection Flag for GPT Output-Disable Request
    #[inline(always)]
    pub fn iocf(&mut self) -> IocfW<PoeggaSpec> {
        IocfW::new(self, 1)
    }
    ///Bit 2 - Oscillation Stop Detection Flag
    #[inline(always)]
    pub fn ostpf(&mut self) -> OstpfW<PoeggaSpec> {
        OstpfW::new(self, 2)
    }
    ///Bit 3 - Software Stop Flag
    #[inline(always)]
    pub fn ssf(&mut self) -> SsfW<PoeggaSpec> {
        SsfW::new(self, 3)
    }
    ///Bit 4 - Port Input Detection Enable
    #[inline(always)]
    pub fn pide(&mut self) -> PideW<PoeggaSpec> {
        PideW::new(self, 4)
    }
    ///Bit 5 - Enable for GPT Output-Disable Request
    #[inline(always)]
    pub fn ioce(&mut self) -> IoceW<PoeggaSpec> {
        IoceW::new(self, 5)
    }
    ///Bit 6 - Oscillation Stop Detection Enable
    #[inline(always)]
    pub fn ostpe(&mut self) -> OstpeW<PoeggaSpec> {
        OstpeW::new(self, 6)
    }
    ///Bit 28 - GTETRGn Input Reverse
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<PoeggaSpec> {
        InvW::new(self, 28)
    }
    ///Bit 29 - Noise Filter Enable
    #[inline(always)]
    pub fn nfen(&mut self) -> NfenW<PoeggaSpec> {
        NfenW::new(self, 29)
    }
    ///Bits 30:31 - Noise Filter Clock Select
    #[inline(always)]
    pub fn nfcs(&mut self) -> NfcsW<PoeggaSpec> {
        NfcsW::new(self, 30)
    }
}
/**POEG Group A Setting Register

You can [`read`](crate::Reg::read) this register and get [`poegga::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`poegga::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PoeggaSpec;
impl crate::RegisterSpec for PoeggaSpec {
    type Ux = u32;
}
///`read()` method returns [`poegga::R`](R) reader structure
impl crate::Readable for PoeggaSpec {}
///`write(|w| ..)` method takes [`poegga::W`](W) writer structure
impl crate::Writable for PoeggaSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets POEGGA to value 0
impl crate::Resettable for PoeggaSpec {}
