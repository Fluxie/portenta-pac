///Register `CFDCFDF14%s_0` reader
pub type R = crate::R<Cfdcfdf14_0Spec>;
///Register `CFDCFDF14%s_0` writer
pub type W = crate::W<Cfdcfdf14_0Spec>;
...
impl W {
    ///Bits 0:7 - Common FIFO Buffer Data Bytes 56
    #[inline(always)]
    pub fn cfdb_ll(&mut self) -> CfdbLlW<Cfdcfdf14_0Spec> {
        CfdbLlW::new(self, 0)
    }
    ///Bits 8:15 - Common FIFO Buffer Data Bytes 57
    #[inline(always)]
    pub fn cfdb_lh(&mut self) -> CfdbLhW<Cfdcfdf14_0Spec> {
        CfdbLhW::new(self, 8)
    }
    ///Bits 16:23 - Common FIFO Buffer Data Bytes 58
    #[inline(always)]
    pub fn cfdb_hl(&mut self) -> CfdbHlW<Cfdcfdf14_0Spec> {
        CfdbHlW::new(self, 16)
    }
    ///Bits 24:31 - Common FIFO Buffer Data Bytes 59
    #[inline(always)]
    pub fn cfdb_hh(&mut self) -> CfdbHhW<Cfdcfdf14_0Spec> {
        CfdbHhW::new(self, 24)
    }
}
/**Common FIFO Access Data Field 14 Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdcfdf14_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfdf14_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfdf14_0Spec;
impl crate::RegisterSpec for Cfdcfdf14_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfdf14_0::R`](R) reader structure
impl crate::Readable for Cfdcfdf14_0Spec {}
///`write(|w| ..)` method takes [`cfdcfdf14_0::W`](W) writer structure
impl crate::Writable for Cfdcfdf14_0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFDF14%s_0 to value 0
impl crate::Resettable for Cfdcfdf14_0Spec {}
