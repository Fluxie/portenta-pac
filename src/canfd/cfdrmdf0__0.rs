///Register `CFDRMDF0_%s_0` reader
pub type R = crate::R<Cfdrmdf0_0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf0__0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf0_0Spec;
impl crate::RegisterSpec for Cfdrmdf0_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf0__0::R`](R) reader structure
impl crate::Readable for Cfdrmdf0_0Spec {}
///`reset()` method sets CFDRMDF0_%s_0 to value 0
impl crate::Resettable for Cfdrmdf0_0Spec {}
