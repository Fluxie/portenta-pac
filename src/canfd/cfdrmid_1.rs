///Register `CFDRMID%s_1` reader
pub type R = crate::R<Cfdrmid1Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmid_1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmid1Spec;
impl crate::RegisterSpec for Cfdrmid1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmid_1::R`](R) reader structure
impl crate::Readable for Cfdrmid1Spec {}
///`reset()` method sets CFDRMID%s_1 to value 0
impl crate::Resettable for Cfdrmid1Spec {}
