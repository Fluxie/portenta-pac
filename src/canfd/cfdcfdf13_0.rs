///Register `CFDCFDF13%s_0` reader
pub type R = crate::R<Cfdcfdf13_0Spec>;
///Register `CFDCFDF13%s_0` writer
pub type W = crate::W<Cfdcfdf13_0Spec>;
...
impl W {
    ///Bits 0:7 - Common FIFO Buffer Data Bytes 52
    #[inline(always)]
    pub fn cfdb_ll(&mut self) -> CfdbLlW<Cfdcfdf13_0Spec> {
        CfdbLlW::new(self, 0)
    }
    ///Bits 8:15 - Common FIFO Buffer Data Bytes 53
    #[inline(always)]
    pub fn cfdb_lh(&mut self) -> CfdbLhW<Cfdcfdf13_0Spec> {
        CfdbLhW::new(self, 8)
    }
    ///Bits 16:23 - Common FIFO Buffer Data Bytes 54
    #[inline(always)]
    pub fn cfdb_hl(&mut self) -> CfdbHlW<Cfdcfdf13_0Spec> {
        CfdbHlW::new(self, 16)
    }
    ///Bits 24:31 - Common FIFO Buffer Data Bytes 55
    #[inline(always)]
    pub fn cfdb_hh(&mut self) -> CfdbHhW<Cfdcfdf13_0Spec> {
        CfdbHhW::new(self, 24)
    }
}
/**Common FIFO Access Data Field 13 Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdcfdf13_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfdf13_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfdf13_0Spec;
impl crate::RegisterSpec for Cfdcfdf13_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfdf13_0::R`](R) reader structure
impl crate::Readable for Cfdcfdf13_0Spec {}
///`write(|w| ..)` method takes [`cfdcfdf13_0::W`](W) writer structure
impl crate::Writable for Cfdcfdf13_0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFDF13%s_0 to value 0
impl crate::Resettable for Cfdcfdf13_0Spec {}
