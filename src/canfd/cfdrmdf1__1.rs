///Register `CFDRMDF1_%s_1` reader
pub type R = crate::R<Cfdrmdf1_1Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf1__1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf1_1Spec;
impl crate::RegisterSpec for Cfdrmdf1_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf1__1::R`](R) reader structure
impl crate::Readable for Cfdrmdf1_1Spec {}
///`reset()` method sets CFDRMDF1_%s_1 to value 0
impl crate::Resettable for Cfdrmdf1_1Spec {}
