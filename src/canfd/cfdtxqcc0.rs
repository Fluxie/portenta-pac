///Register `CFDTXQCC0%s` reader
pub type R = crate::R<Cfdtxqcc0Spec>;
///Register `CFDTXQCC0%s` writer
pub type W = crate::W<Cfdtxqcc0Spec>;
/**TX Queue Enable
...
impl W {
    ///Bit 0 - TX Queue Enable
    #[inline(always)]
    pub fn txqe(&mut self) -> TxqeW<Cfdtxqcc0Spec> {
        TxqeW::new(self, 0)
    }
    ///Bit 1 - TX Queue Gateway Mode Enable
    #[inline(always)]
    pub fn txqgwe(&mut self) -> TxqgweW<Cfdtxqcc0Spec> {
        TxqgweW::new(self, 1)
    }
    ///Bit 5 - TX Queue TX Interrupt Enable
    #[inline(always)]
    pub fn txqtxie(&mut self) -> TxqtxieW<Cfdtxqcc0Spec> {
        TxqtxieW::new(self, 5)
    }
    ///Bit 7 - TX Queue Interrupt Mode
    #[inline(always)]
    pub fn txqim(&mut self) -> TxqimW<Cfdtxqcc0Spec> {
        TxqimW::new(self, 7)
    }
    ///Bits 8:12 - TX Queue Depth Configuration
    #[inline(always)]
    pub fn txqdc(&mut self) -> TxqdcW<Cfdtxqcc0Spec> {
        TxqdcW::new(self, 8)
    }
    ///Bit 16 - TXQ Full Interrupt Enable
    #[inline(always)]
    pub fn txqfie(&mut self) -> TxqfieW<Cfdtxqcc0Spec> {
        TxqfieW::new(self, 16)
    }
    ///Bit 17 - TXQ One Frame Reception Interrupt Enable
    #[inline(always)]
    pub fn txqofrxie(&mut self) -> TxqofrxieW<Cfdtxqcc0Spec> {
        TxqofrxieW::new(self, 17)
    }
    ///Bit 18 - TXQ One Frame Transmission Interrupt Enable
    #[inline(always)]
    pub fn txqoftxie(&mut self) -> TxqoftxieW<Cfdtxqcc0Spec> {
        TxqoftxieW::new(self, 18)
    }
}
/**TX Queue Configuration/Control Registers 0%s

You can [`read`](crate::Reg::read) this register and get [`cfdtxqcc0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtxqcc0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtxqcc0Spec;
impl crate::RegisterSpec for Cfdtxqcc0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtxqcc0::R`](R) reader structure
impl crate::Readable for Cfdtxqcc0Spec {}
///`write(|w| ..)` method takes [`cfdtxqcc0::W`](W) writer structure
impl crate::Writable for Cfdtxqcc0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTXQCC0%s to value 0
impl crate::Resettable for Cfdtxqcc0Spec {}
