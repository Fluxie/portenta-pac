///Register `CFDRMFDSTS%s_0` reader
pub type R = crate::R<Cfdrmfdsts0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmfdsts_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmfdsts0Spec;
impl crate::RegisterSpec for Cfdrmfdsts0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmfdsts_0::R`](R) reader structure
impl crate::Readable for Cfdrmfdsts0Spec {}
///`reset()` method sets CFDRMFDSTS%s_0 to value 0
impl crate::Resettable for Cfdrmfdsts0Spec {}
