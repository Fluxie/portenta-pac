///Register `CFDRMDF4_%s_0` reader
pub type R = crate::R<Cfdrmdf4_0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf4__0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf4_0Spec;
impl crate::RegisterSpec for Cfdrmdf4_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf4__0::R`](R) reader structure
impl crate::Readable for Cfdrmdf4_0Spec {}
///`reset()` method sets CFDRMDF4_%s_0 to value 0
impl crate::Resettable for Cfdrmdf4_0Spec {}
