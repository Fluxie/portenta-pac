///Register `CFDCFDF8%s_0` reader
pub type R = crate::R<Cfdcfdf8_0Spec>;
///Register `CFDCFDF8%s_0` writer
pub type W = crate::W<Cfdcfdf8_0Spec>;
...
impl W {
    ///Bits 0:7 - Common FIFO Buffer Data Bytes 32
    #[inline(always)]
    pub fn cfdb_ll(&mut self) -> CfdbLlW<Cfdcfdf8_0Spec> {
        CfdbLlW::new(self, 0)
    }
    ///Bits 8:15 - Common FIFO Buffer Data Bytes 33
    #[inline(always)]
    pub fn cfdb_lh(&mut self) -> CfdbLhW<Cfdcfdf8_0Spec> {
        CfdbLhW::new(self, 8)
    }
    ///Bits 16:23 - Common FIFO Buffer Data Bytes 34
    #[inline(always)]
    pub fn cfdb_hl(&mut self) -> CfdbHlW<Cfdcfdf8_0Spec> {
        CfdbHlW::new(self, 16)
    }
    ///Bits 24:31 - Common FIFO Buffer Data Bytes 35
    #[inline(always)]
    pub fn cfdb_hh(&mut self) -> CfdbHhW<Cfdcfdf8_0Spec> {
        CfdbHhW::new(self, 24)
    }
}
/**Common FIFO Access Data Field 8 Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdcfdf8_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfdf8_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfdf8_0Spec;
impl crate::RegisterSpec for Cfdcfdf8_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfdf8_0::R`](R) reader structure
impl crate::Readable for Cfdcfdf8_0Spec {}
///`write(|w| ..)` method takes [`cfdcfdf8_0::W`](W) writer structure
impl crate::Writable for Cfdcfdf8_0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFDF8%s_0 to value 0
impl crate::Resettable for Cfdcfdf8_0Spec {}
