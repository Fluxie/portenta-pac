///Register `CFDTXQSTS0%s` reader
pub type R = crate::R<Cfdtxqsts0Spec>;
///Register `CFDTXQSTS0%s` writer
pub type W = crate::W<Cfdtxqsts0Spec>;
/**TX Queue Empty
...
impl W {
    ///Bit 2 - TX Queue TX Interrupt Flag
    #[inline(always)]
    pub fn txqtxif(&mut self) -> TxqtxifW<Cfdtxqsts0Spec> {
        TxqtxifW::new(self, 2)
    }
    ///Bit 16 - TXQ Full Interrupt Flag
    #[inline(always)]
    pub fn txqfif(&mut self) -> TxqfifW<Cfdtxqsts0Spec> {
        TxqfifW::new(self, 16)
    }
    ///Bit 17 - TXQ One Frame Reception Interrupt Flag
    #[inline(always)]
    pub fn txqofrxif(&mut self) -> TxqofrxifW<Cfdtxqsts0Spec> {
        TxqofrxifW::new(self, 17)
    }
    ///Bit 18 - TXQ One Frame Transmission Interrupt Flag
    #[inline(always)]
    pub fn txqoftxif(&mut self) -> TxqoftxifW<Cfdtxqsts0Spec> {
        TxqoftxifW::new(self, 18)
    }
    ///Bit 19 - TXQ Message Lost
    #[inline(always)]
    pub fn txqmlt(&mut self) -> TxqmltW<Cfdtxqsts0Spec> {
        TxqmltW::new(self, 19)
    }
}
/**TX Queue Status Registers 0%s

You can [`read`](crate::Reg::read) this register and get [`cfdtxqsts0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtxqsts0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtxqsts0Spec;
impl crate::RegisterSpec for Cfdtxqsts0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtxqsts0::R`](R) reader structure
impl crate::Readable for Cfdtxqsts0Spec {}
///`write(|w| ..)` method takes [`cfdtxqsts0::W`](W) writer structure
impl crate::Writable for Cfdtxqsts0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTXQSTS0%s to value 0x01
impl crate::Resettable for Cfdtxqsts0Spec {
