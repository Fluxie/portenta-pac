///Register `CFDCFID%s_0` reader
pub type R = crate::R<Cfdcfid0Spec>;
///Register `CFDCFID%s_0` writer
pub type W = crate::W<Cfdcfid0Spec>;
...
impl W {
    ///Bits 0:28 - Common FIFO Buffer ID Field
    #[inline(always)]
    pub fn cfid(&mut self) -> CfidW<Cfdcfid0Spec> {
        CfidW::new(self, 0)
    }
    ///Bit 29 - THL Entry Enable
    #[inline(always)]
    pub fn thlen(&mut self) -> ThlenW<Cfdcfid0Spec> {
        ThlenW::new(self, 29)
    }
    ///Bit 30 - Common FIFO Buffer RTR bit
    #[inline(always)]
    pub fn cfrtr(&mut self) -> CfrtrW<Cfdcfid0Spec> {
        CfrtrW::new(self, 30)
    }
    ///Bit 31 - Common FIFO Buffer IDE bit
    #[inline(always)]
    pub fn cfide(&mut self) -> CfideW<Cfdcfid0Spec> {
        CfideW::new(self, 31)
    }
}
/**Common FIFO Access ID Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdcfid_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfid_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfid0Spec;
impl crate::RegisterSpec for Cfdcfid0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfid_0::R`](R) reader structure
impl crate::Readable for Cfdcfid0Spec {}
///`write(|w| ..)` method takes [`cfdcfid_0::W`](W) writer structure
impl crate::Writable for Cfdcfid0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFID%s_0 to value 0
impl crate::Resettable for Cfdcfid0Spec {}
