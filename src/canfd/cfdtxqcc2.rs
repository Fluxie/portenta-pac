///Register `CFDTXQCC2%s` reader
pub type R = crate::R<Cfdtxqcc2Spec>;
///Register `CFDTXQCC2%s` writer
pub type W = crate::W<Cfdtxqcc2Spec>;
/**TX Queue Enable
...
impl W {
    ///Bit 0 - TX Queue Enable
    #[inline(always)]
    pub fn txqe(&mut self) -> TxqeW<Cfdtxqcc2Spec> {
        TxqeW::new(self, 0)
    }
    ///Bit 1 - TX Queue Gateway Mode Enable
    #[inline(always)]
    pub fn txqgwe(&mut self) -> TxqgweW<Cfdtxqcc2Spec> {
        TxqgweW::new(self, 1)
    }
    ///Bit 5 - TX Queue TX Interrupt Enable
    #[inline(always)]
    pub fn txqtxie(&mut self) -> TxqtxieW<Cfdtxqcc2Spec> {
        TxqtxieW::new(self, 5)
    }
    ///Bit 7 - TX Queue Interrupt Mode
    #[inline(always)]
    pub fn txqim(&mut self) -> TxqimW<Cfdtxqcc2Spec> {
        TxqimW::new(self, 7)
    }
    ///Bits 8:12 - TX Queue Depth Configuration
    #[inline(always)]
    pub fn txqdc(&mut self) -> TxqdcW<Cfdtxqcc2Spec> {
        TxqdcW::new(self, 8)
    }
    ///Bit 16 - TXQ Full Interrupt Enable
    #[inline(always)]
    pub fn txqfie(&mut self) -> TxqfieW<Cfdtxqcc2Spec> {
        TxqfieW::new(self, 16)
    }
    ///Bit 17 - TXQ One Frame Reception Interrupt Enable
    #[inline(always)]
    pub fn txqofrxie(&mut self) -> TxqofrxieW<Cfdtxqcc2Spec> {
        TxqofrxieW::new(self, 17)
    }
    ///Bit 18 - TXQ One Frame Transmission Interrupt Enable
    #[inline(always)]
    pub fn txqoftxie(&mut self) -> TxqoftxieW<Cfdtxqcc2Spec> {
        TxqoftxieW::new(self, 18)
    }
}
/**TX Queue Configuration/Control Registers 2%s

You can [`read`](crate::Reg::read) this register and get [`cfdtxqcc2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtxqcc2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtxqcc2Spec;
impl crate::RegisterSpec for Cfdtxqcc2Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtxqcc2::R`](R) reader structure
impl crate::Readable for Cfdtxqcc2Spec {}
///`write(|w| ..)` method takes [`cfdtxqcc2::W`](W) writer structure
impl crate::Writable for Cfdtxqcc2Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTXQCC2%s to value 0
impl crate::Resettable for Cfdtxqcc2Spec {}
