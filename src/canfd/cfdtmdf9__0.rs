///Register `CFDTMDF9_%s_0` reader
pub type R = crate::R<Cfdtmdf9_0Spec>;
///Register `CFDTMDF9_%s_0` writer
pub type W = crate::W<Cfdtmdf9_0Spec>;
...
impl W {
    ///Bits 0:7 - TX Message Buffer Data Byte 36
    #[inline(always)]
    pub fn tmdb_ll(&mut self) -> TmdbLlW<Cfdtmdf9_0Spec> {
        TmdbLlW::new(self, 0)
    }
    ///Bits 8:15 - TX Message Buffer Data Byte 37
    #[inline(always)]
    pub fn tmdb_lh(&mut self) -> TmdbLhW<Cfdtmdf9_0Spec> {
        TmdbLhW::new(self, 8)
    }
    ///Bits 16:23 - TX Message Buffer Data Byte 38
    #[inline(always)]
    pub fn tmdb_hl(&mut self) -> TmdbHlW<Cfdtmdf9_0Spec> {
        TmdbHlW::new(self, 16)
    }
    ///Bits 24:31 - TX Message Buffer Data Byte 39
    #[inline(always)]
    pub fn tmdb_hh(&mut self) -> TmdbHhW<Cfdtmdf9_0Spec> {
        TmdbHhW::new(self, 24)
    }
}
/**TX Message Buffer Data Field 9 Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdtmdf9__0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtmdf9__0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtmdf9_0Spec;
impl crate::RegisterSpec for Cfdtmdf9_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtmdf9__0::R`](R) reader structure
impl crate::Readable for Cfdtmdf9_0Spec {}
///`write(|w| ..)` method takes [`cfdtmdf9__0::W`](W) writer structure
impl crate::Writable for Cfdtmdf9_0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTMDF9_%s_0 to value 0
impl crate::Resettable for Cfdtmdf9_0Spec {}
