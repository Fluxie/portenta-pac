///Register `CFDTMID%s_1` reader
pub type R = crate::R<Cfdtmid1Spec>;
///Register `CFDTMID%s_1` writer
pub type W = crate::W<Cfdtmid1Spec>;
...
impl W {
    ///Bits 0:28 - TX Message Buffer ID Field
    #[inline(always)]
    pub fn tmid(&mut self) -> TmidW<Cfdtmid1Spec> {
        TmidW::new(self, 0)
    }
    ///Bit 29 - Tx History List Entry
    #[inline(always)]
    pub fn thlen(&mut self) -> ThlenW<Cfdtmid1Spec> {
        ThlenW::new(self, 29)
    }
    ///Bit 30 - TX Message Buffer RTR bit
    #[inline(always)]
    pub fn tmrtr(&mut self) -> TmrtrW<Cfdtmid1Spec> {
        TmrtrW::new(self, 30)
    }
    ///Bit 31 - TX Message Buffer IDE bit
    #[inline(always)]
    pub fn tmide(&mut self) -> TmideW<Cfdtmid1Spec> {
        TmideW::new(self, 31)
    }
}
/**TX Message Buffer ID Register %s Channel 1

You can [`read`](crate::Reg::read) this register and get [`cfdtmid_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtmid_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtmid1Spec;
impl crate::RegisterSpec for Cfdtmid1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtmid_1::R`](R) reader structure
impl crate::Readable for Cfdtmid1Spec {}
///`write(|w| ..)` method takes [`cfdtmid_1::W`](W) writer structure
impl crate::Writable for Cfdtmid1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTMID%s_1 to value 0
impl crate::Resettable for Cfdtmid1Spec {}
