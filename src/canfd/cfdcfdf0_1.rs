///Register `CFDCFDF0%s_1` reader
pub type R = crate::R<Cfdcfdf0_1Spec>;
///Register `CFDCFDF0%s_1` writer
pub type W = crate::W<Cfdcfdf0_1Spec>;
...
impl W {
    ///Bits 0:7 - Common FIFO Buffer Data Bytes 0
    #[inline(always)]
    pub fn cfdb_ll(&mut self) -> CfdbLlW<Cfdcfdf0_1Spec> {
        CfdbLlW::new(self, 0)
    }
    ///Bits 8:15 - Common FIFO Buffer Data Bytes 1
    #[inline(always)]
    pub fn cfdb_lh(&mut self) -> CfdbLhW<Cfdcfdf0_1Spec> {
        CfdbLhW::new(self, 8)
    }
    ///Bits 16:23 - Common FIFO Buffer Data Bytes 2
    #[inline(always)]
    pub fn cfdb_hl(&mut self) -> CfdbHlW<Cfdcfdf0_1Spec> {
        CfdbHlW::new(self, 16)
    }
    ///Bits 24:31 - Common FIFO Buffer Data Bytes 3
    #[inline(always)]
    pub fn cfdb_hh(&mut self) -> CfdbHhW<Cfdcfdf0_1Spec> {
        CfdbHhW::new(self, 24)
    }
}
/**Common FIFO Access Data Field 0 Register %s Channel 1

You can [`read`](crate::Reg::read) this register and get [`cfdcfdf0_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfdf0_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfdf0_1Spec;
impl crate::RegisterSpec for Cfdcfdf0_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfdf0_1::R`](R) reader structure
impl crate::Readable for Cfdcfdf0_1Spec {}
///`write(|w| ..)` method takes [`cfdcfdf0_1::W`](W) writer structure
impl crate::Writable for Cfdcfdf0_1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFDF0%s_1 to value 0
impl crate::Resettable for Cfdcfdf0_1Spec {}
