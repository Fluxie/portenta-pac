///Register `CFDRMDF8_%s_0` reader
pub type R = crate::R<Cfdrmdf8_0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf8__0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf8_0Spec;
impl crate::RegisterSpec for Cfdrmdf8_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf8__0::R`](R) reader structure
impl crate::Readable for Cfdrmdf8_0Spec {}
///`reset()` method sets CFDRMDF8_%s_0 to value 0
impl crate::Resettable for Cfdrmdf8_0Spec {}
