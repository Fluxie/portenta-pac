///Register `CFDTXQSTS2%s` reader
pub type R = crate::R<Cfdtxqsts2Spec>;
///Register `CFDTXQSTS2%s` writer
pub type W = crate::W<Cfdtxqsts2Spec>;
/**TX Queue Empty
...
impl W {
    ///Bit 2 - TX Queue TX Interrupt Flag
    #[inline(always)]
    pub fn txqtxif(&mut self) -> TxqtxifW<Cfdtxqsts2Spec> {
        TxqtxifW::new(self, 2)
    }
    ///Bit 16 - TXQ Full Interrupt Flag
    #[inline(always)]
    pub fn txqfif(&mut self) -> TxqfifW<Cfdtxqsts2Spec> {
        TxqfifW::new(self, 16)
    }
    ///Bit 17 - TXQ One Frame Reception Interrupt Flag
    #[inline(always)]
    pub fn txqofrxif(&mut self) -> TxqofrxifW<Cfdtxqsts2Spec> {
        TxqofrxifW::new(self, 17)
    }
    ///Bit 18 - TXQ One Frame Transmission Interrupt Flag
    #[inline(always)]
    pub fn txqoftxif(&mut self) -> TxqoftxifW<Cfdtxqsts2Spec> {
        TxqoftxifW::new(self, 18)
    }
    ///Bit 19 - TXQ Message Lost
    #[inline(always)]
    pub fn txqmlt(&mut self) -> TxqmltW<Cfdtxqsts2Spec> {
        TxqmltW::new(self, 19)
    }
}
/**TX Queue Status Registers 2%s

You can [`read`](crate::Reg::read) this register and get [`cfdtxqsts2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtxqsts2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtxqsts2Spec;
impl crate::RegisterSpec for Cfdtxqsts2Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtxqsts2::R`](R) reader structure
impl crate::Readable for Cfdtxqsts2Spec {}
///`write(|w| ..)` method takes [`cfdtxqsts2::W`](W) writer structure
impl crate::Writable for Cfdtxqsts2Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTXQSTS2%s to value 0x01
impl crate::Resettable for Cfdtxqsts2Spec {
