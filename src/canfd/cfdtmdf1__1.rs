///Register `CFDTMDF1_%s_1` reader
pub type R = crate::R<Cfdtmdf1_1Spec>;
///Register `CFDTMDF1_%s_1` writer
pub type W = crate::W<Cfdtmdf1_1Spec>;
...
impl W {
    ///Bits 0:7 - TX Message Buffer Data Byte 4
    #[inline(always)]
    pub fn tmdb_ll(&mut self) -> TmdbLlW<Cfdtmdf1_1Spec> {
        TmdbLlW::new(self, 0)
    }
    ///Bits 8:15 - TX Message Buffer Data Byte 5
    #[inline(always)]
    pub fn tmdb_lh(&mut self) -> TmdbLhW<Cfdtmdf1_1Spec> {
        TmdbLhW::new(self, 8)
    }
    ///Bits 16:23 - TX Message Buffer Data Byte 6
    #[inline(always)]
    pub fn tmdb_hl(&mut self) -> TmdbHlW<Cfdtmdf1_1Spec> {
        TmdbHlW::new(self, 16)
    }
    ///Bits 24:31 - TX Message Buffer Data Byte 7
    #[inline(always)]
    pub fn tmdb_hh(&mut self) -> TmdbHhW<Cfdtmdf1_1Spec> {
        TmdbHhW::new(self, 24)
    }
}
/**TX Message Buffer Data Field 1 Register %s Channel 1

You can [`read`](crate::Reg::read) this register and get [`cfdtmdf1__1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtmdf1__1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtmdf1_1Spec;
impl crate::RegisterSpec for Cfdtmdf1_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtmdf1__1::R`](R) reader structure
impl crate::Readable for Cfdtmdf1_1Spec {}
///`write(|w| ..)` method takes [`cfdtmdf1__1::W`](W) writer structure
impl crate::Writable for Cfdtmdf1_1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTMDF1_%s_1 to value 0
impl crate::Resettable for Cfdtmdf1_1Spec {}
