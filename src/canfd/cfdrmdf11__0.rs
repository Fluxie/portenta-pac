///Register `CFDRMDF11_%s_0` reader
pub type R = crate::R<Cfdrmdf11_0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf11__0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf11_0Spec;
impl crate::RegisterSpec for Cfdrmdf11_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf11__0::R`](R) reader structure
impl crate::Readable for Cfdrmdf11_0Spec {}
///`reset()` method sets CFDRMDF11_%s_0 to value 0
impl crate::Resettable for Cfdrmdf11_0Spec {}
