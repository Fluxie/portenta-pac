///Register `CFDCFFDCSTS%s_0` reader
pub type R = crate::R<Cfdcffdcsts0Spec>;
///Register `CFDCFFDCSTS%s_0` writer
pub type W = crate::W<Cfdcffdcsts0Spec>;
...
impl W {
    ///Bit 0 - Error State Indicator bit
    #[inline(always)]
    pub fn cfesi(&mut self) -> CfesiW<Cfdcffdcsts0Spec> {
        CfesiW::new(self, 0)
    }
    ///Bit 1 - Bit Rate Switch bit
    #[inline(always)]
    pub fn cfbrs(&mut self) -> CfbrsW<Cfdcffdcsts0Spec> {
        CfbrsW::new(self, 1)
    }
    ///Bit 2 - CAN FD Format bit
    #[inline(always)]
    pub fn cffdf(&mut self) -> CffdfW<Cfdcffdcsts0Spec> {
        CffdfW::new(self, 2)
    }
    ///Bits 8:9 - COMMON FIFO Buffer Information Label Field
    #[inline(always)]
    pub fn cfifl(&mut self) -> CfiflW<Cfdcffdcsts0Spec> {
        CfiflW::new(self, 8)
    }
    ///Bits 16:31 - Common FIFO Buffer Pointer Field
    #[inline(always)]
    pub fn cfptr(&mut self) -> CfptrW<Cfdcffdcsts0Spec> {
        CfptrW::new(self, 16)
    }
}
/**Common FIFO Access CAN-FD Control/Status Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdcffdcsts_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcffdcsts_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcffdcsts0Spec;
impl crate::RegisterSpec for Cfdcffdcsts0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcffdcsts_0::R`](R) reader structure
impl crate::Readable for Cfdcffdcsts0Spec {}
///`write(|w| ..)` method takes [`cfdcffdcsts_0::W`](W) writer structure
impl crate::Writable for Cfdcffdcsts0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFFDCSTS%s_0 to value 0
impl crate::Resettable for Cfdcffdcsts0Spec {}
