///Register `CFDRMDF13_%s_0` reader
pub type R = crate::R<Cfdrmdf13_0Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf13__0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf13_0Spec;
impl crate::RegisterSpec for Cfdrmdf13_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf13__0::R`](R) reader structure
impl crate::Readable for Cfdrmdf13_0Spec {}
///`reset()` method sets CFDRMDF13_%s_0 to value 0
impl crate::Resettable for Cfdrmdf13_0Spec {}
