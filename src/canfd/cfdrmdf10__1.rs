///Register `CFDRMDF10_%s_1` reader
pub type R = crate::R<Cfdrmdf10_1Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf10__1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf10_1Spec;
impl crate::RegisterSpec for Cfdrmdf10_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf10__1::R`](R) reader structure
impl crate::Readable for Cfdrmdf10_1Spec {}
///`reset()` method sets CFDRMDF10_%s_1 to value 0
impl crate::Resettable for Cfdrmdf10_1Spec {}
