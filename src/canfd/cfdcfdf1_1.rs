///Register `CFDCFDF1%s_1` reader
pub type R = crate::R<Cfdcfdf1_1Spec>;
///Register `CFDCFDF1%s_1` writer
pub type W = crate::W<Cfdcfdf1_1Spec>;
...
impl W {
    ///Bits 0:7 - Common FIFO Buffer Data Bytes 4
    #[inline(always)]
    pub fn cfdb_ll(&mut self) -> CfdbLlW<Cfdcfdf1_1Spec> {
        CfdbLlW::new(self, 0)
    }
    ///Bits 8:15 - Common FIFO Buffer Data Bytes 5
    #[inline(always)]
    pub fn cfdb_lh(&mut self) -> CfdbLhW<Cfdcfdf1_1Spec> {
        CfdbLhW::new(self, 8)
    }
    ///Bits 16:23 - Common FIFO Buffer Data Bytes 6
    #[inline(always)]
    pub fn cfdb_hl(&mut self) -> CfdbHlW<Cfdcfdf1_1Spec> {
        CfdbHlW::new(self, 16)
    }
    ///Bits 24:31 - Common FIFO Buffer Data Bytes 7
    #[inline(always)]
    pub fn cfdb_hh(&mut self) -> CfdbHhW<Cfdcfdf1_1Spec> {
        CfdbHhW::new(self, 24)
    }
}
/**Common FIFO Access Data Field 1 Register %s Channel 1

You can [`read`](crate::Reg::read) this register and get [`cfdcfdf1_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdcfdf1_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdcfdf1_1Spec;
impl crate::RegisterSpec for Cfdcfdf1_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdcfdf1_1::R`](R) reader structure
impl crate::Readable for Cfdcfdf1_1Spec {}
///`write(|w| ..)` method takes [`cfdcfdf1_1::W`](W) writer structure
impl crate::Writable for Cfdcfdf1_1Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDCFDF1%s_1 to value 0
impl crate::Resettable for Cfdcfdf1_1Spec {}
