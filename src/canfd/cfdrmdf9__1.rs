///Register `CFDRMDF9_%s_1` reader
pub type R = crate::R<Cfdrmdf9_1Spec>;
...
You can [`read`](crate::Reg::read) this register and get [`cfdrmdf9__1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdrmdf9_1Spec;
impl crate::RegisterSpec for Cfdrmdf9_1Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdrmdf9__1::R`](R) reader structure
impl crate::Readable for Cfdrmdf9_1Spec {}
///`reset()` method sets CFDRMDF9_%s_1 to value 0
impl crate::Resettable for Cfdrmdf9_1Spec {}
