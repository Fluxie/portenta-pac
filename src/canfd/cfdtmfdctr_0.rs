///Register `CFDTMFDCTR%s_0` reader
pub type R = crate::R<Cfdtmfdctr0Spec>;
///Register `CFDTMFDCTR%s_0` writer
pub type W = crate::W<Cfdtmfdctr0Spec>;
...
impl W {
    ///Bit 0 - Error State Indicator bit
    #[inline(always)]
    pub fn tmesi(&mut self) -> TmesiW<Cfdtmfdctr0Spec> {
        TmesiW::new(self, 0)
    }
    ///Bit 1 - Bit Rate Switch bit
    #[inline(always)]
    pub fn tmbrs(&mut self) -> TmbrsW<Cfdtmfdctr0Spec> {
        TmbrsW::new(self, 1)
    }
    ///Bit 2 - CAN FD Format bit
    #[inline(always)]
    pub fn tmfdf(&mut self) -> TmfdfW<Cfdtmfdctr0Spec> {
        TmfdfW::new(self, 2)
    }
    ///Bits 8:9 - TX Message Buffer Information Label Field
    #[inline(always)]
    pub fn tmifl(&mut self) -> TmiflW<Cfdtmfdctr0Spec> {
        TmiflW::new(self, 8)
    }
    ///Bits 16:31 - TX Message Buffer Pointer Field
    #[inline(always)]
    pub fn tmptr(&mut self) -> TmptrW<Cfdtmfdctr0Spec> {
        TmptrW::new(self, 16)
    }
}
/**TX Message Buffer CANFD Control Register %s Channel i

You can [`read`](crate::Reg::read) this register and get [`cfdtmfdctr_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtmfdctr_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtmfdctr0Spec;
impl crate::RegisterSpec for Cfdtmfdctr0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtmfdctr_0::R`](R) reader structure
impl crate::Readable for Cfdtmfdctr0Spec {}
///`write(|w| ..)` method takes [`cfdtmfdctr_0::W`](W) writer structure
impl crate::Writable for Cfdtmfdctr0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTMFDCTR%s_0 to value 0
impl crate::Resettable for Cfdtmfdctr0Spec {}
