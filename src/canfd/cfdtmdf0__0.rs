///Register `CFDTMDF0_%s_0` reader
pub type R = crate::R<Cfdtmdf0_0Spec>;
///Register `CFDTMDF0_%s_0` writer
pub type W = crate::W<Cfdtmdf0_0Spec>;
...
impl W {
    ///Bits 0:7 - TX Message Buffer Data Byte 0
    #[inline(always)]
    pub fn tmdb_ll(&mut self) -> TmdbLlW<Cfdtmdf0_0Spec> {
        TmdbLlW::new(self, 0)
    }
    ///Bits 8:15 - TX Message Buffer Data Byte 1
    #[inline(always)]
    pub fn tmdb_lh(&mut self) -> TmdbLhW<Cfdtmdf0_0Spec> {
        TmdbLhW::new(self, 8)
    }
    ///Bits 16:23 - TX Message Buffer Data Byte 2
    #[inline(always)]
    pub fn tmdb_hl(&mut self) -> TmdbHlW<Cfdtmdf0_0Spec> {
        TmdbHlW::new(self, 16)
    }
    ///Bits 24:31 - TX Message Buffer Data Byte 3
    #[inline(always)]
    pub fn tmdb_hh(&mut self) -> TmdbHhW<Cfdtmdf0_0Spec> {
        TmdbHhW::new(self, 24)
    }
}
/**TX Message Buffer Data Field 0 Register %s Channel 0

You can [`read`](crate::Reg::read) this register and get [`cfdtmdf0__0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfdtmdf0__0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct Cfdtmdf0_0Spec;
impl crate::RegisterSpec for Cfdtmdf0_0Spec {
    type Ux = u32;
}
///`read()` method returns [`cfdtmdf0__0::R`](R) reader structure
impl crate::Readable for Cfdtmdf0_0Spec {}
///`write(|w| ..)` method takes [`cfdtmdf0__0::W`](W) writer structure
impl crate::Writable for Cfdtmdf0_0Spec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CFDTMDF0_%s_0 to value 0
impl crate::Resettable for Cfdtmdf0_0Spec {}
