...
///Field `SACKE` reader - Setup Transaction Normal Response Interrupt Request Enable
...
///Field `SACKE` writer - Setup Transaction Normal Response Interrupt Request Enable
...
///Field `SIGNE` reader - Setup Transaction Error Interrupt Request Enable
...
///Field `SIGNE` writer - Setup Transaction Error Interrupt Request Enable
...
///Field `EOFERRE` reader - EOF Error Detection Interrupt Request Enable
...
///Field `EOFERRE` writer - EOF Error Detection Interrupt Request Enable
...
impl From<Lpmende> for bool {
    #[inline(always)]
    fn from(variant: Lpmende) -> Self {
        variant as u8 != 0
    }
}
///Field `LPMENDE` reader - LPM Transaction End Interrupt Request Enable
pub type LpmendeR = crate::BitReader<Lpmende>;
impl LpmendeR {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Lpmende {
        match self.bits {
            false => Lpmende::_0,
            true => Lpmende::_1,
        }
...
///Field `LPMENDE` writer - LPM Transaction End Interrupt Request Enable
pub type LpmendeW<'a, REG> = crate::BitWriter<'a, REG, Lpmende>;
impl<'a, REG> LpmendeW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Disable interrupt request
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Lpmende::_0)
    }
    ///Enable interrupt request
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Lpmende::_1)
    }
}
...
impl From<L1rsmende> for bool {
    #[inline(always)]
    fn from(variant: L1rsmende) -> Self {
        variant as u8 != 0
    }
}
///Field `L1RSMENDE` reader - L1 Resume End Interrupt Enable
pub type L1rsmendeR = crate::BitReader<L1rsmende>;
impl L1rsmendeR {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> L1rsmende {
        match self.bits {
            false => L1rsmende::_0,
            true => L1rsmende::_1,
        }
...
pub type L1rsmendeW<'a, REG> = crate::BitWriter<'a, REG, L1rsmende>;
impl<'a, REG> L1rsmendeW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Disable interrupt request
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(L1rsmende::_0)
    }
    ///Enable interrupt request
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(L1rsmende::_1)
    }
}
...
///Field `ATTCHE` reader - Connection Detection Interrupt Request Enable
...
///Field `ATTCHE` writer - Connection Detection Interrupt Request Enable
...
///Field `DTCHE` reader - Disconnection Detection Interrupt Request Enable
...
///Field `DTCHE` writer - Disconnection Detection Interrupt Request Enable
...
///Field `BCHGE` reader - USB Bus Change Interrupt Request Enable
...
///Field `BCHGE` writer - USB Bus Change Interrupt Request Enable
...
///Field `OVRCRE` reader - OVRCRE Interrupt Request Enable
...
///Field `OVRCRE` writer - OVRCRE Interrupt Request Enable
...
impl R {
    ...
    ///Bit 4 - Setup Transaction Normal Response Interrupt Request Enable
    #[inline(always)]
    pub fn sacke(&self) -> SackeR {
        SackeR::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Setup Transaction Error Interrupt Request Enable
    #[inline(always)]
    pub fn signe(&self) -> SigneR {
        SigneR::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - EOF Error Detection Interrupt Request Enable
    #[inline(always)]
    pub fn eoferre(&self) -> EoferreR {
        EoferreR::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 8 - LPM Transaction End Interrupt Request Enable
    #[inline(always)]
    pub fn lpmende(&self) -> LpmendeR {
        LpmendeR::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - L1 Resume End Interrupt Enable
    #[inline(always)]
    pub fn l1rsmende(&self) -> L1rsmendeR {
        L1rsmendeR::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 11 - Connection Detection Interrupt Request Enable
    #[inline(always)]
    pub fn attche(&self) -> AttcheR {
        AttcheR::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Disconnection Detection Interrupt Request Enable
    #[inline(always)]
    pub fn dtche(&self) -> DtcheR {
        DtcheR::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 14 - USB Bus Change Interrupt Request Enable
    #[inline(always)]
    pub fn bchge(&self) -> BchgeR {
        BchgeR::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - OVRCRE Interrupt Request Enable
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTENB1")
            ...
            .field("lpmende", &self.lpmende())
            .field("l1rsmende", &self.l1rsmende())
...
impl W {
    ...
    ///Bit 8 - LPM Transaction End Interrupt Request Enable
    #[inline(always)]
    pub fn lpmende(&mut self) -> LpmendeW<Intenb1Spec> {
        LpmendeW::new(self, 8)
    }
    ///Bit 9 - L1 Resume End Interrupt Enable
    #[inline(always)]
    pub fn l1rsmende(&mut self) -> L1rsmendeW<Intenb1Spec> {
        L1rsmendeW::new(self, 9)
    }
    ///Bit 11 - Connection Detection Interrupt Request Enable
    #[inline(always)]
