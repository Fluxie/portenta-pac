...
pub type R = crate::R<DevaddaSpec>;
///Register `DEVADDA` writer
pub type W = crate::W<DevaddaSpec>;
...
impl W {
    ///Bits 6:7 - Transfer Speed of Communication Target Device
    #[inline(always)]
    pub fn usbspd(&mut self) -> UsbspdW<DevaddaSpec> {
        UsbspdW::new(self, 6)
    }
    ///Bits 8:10 - Communication Target Connecting Hub Port
    #[inline(always)]
    pub fn hubport(&mut self) -> HubportW<DevaddaSpec> {
        HubportW::new(self, 8)
    }
    ///Bits 11:14 - Communication Target Connecting Hub Register
    #[inline(always)]
    pub fn upphub(&mut self) -> UpphubW<DevaddaSpec> {
        UpphubW::new(self, 11)
    }
}
...
pub struct DevaddaSpec;
impl crate::RegisterSpec for DevaddaSpec {
    type Ux = u16;
}
///`read()` method returns [`devadda::R`](R) reader structure
impl crate::Readable for DevaddaSpec {}
///`write(|w| ..)` method takes [`devadda::W`](W) writer structure
impl crate::Writable for DevaddaSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DEVADDA to value 0
impl crate::Resettable for DevaddaSpec {}
