...
pub enum Type {
    ///0: Pipe not used
    _00 = 0,
    ///1: (Pipe 1 to 5) Bulk transfer (Pipe 6 to 9) Setting prohibited
    _01 = 1,
    ///2: (Pipe 1 to 5) Setting prohibited (Pipe 6 to 9) Interrupt transfer
    _10 = 2,
    ///3: (Pipe 1 to 2) Isochronous transfer (Pipe 3 to 9) Setting prohibited
    _11 = 3,
}
...
impl W {
    ...
    ///Bit 8 - Continuous Transfer Mode
    #[inline(always)]
    pub fn cntmd(&mut self) -> CntmdW<PipecfgSpec> {
        CntmdW::new(self, 8)
    }
    ///Bit 9 - Double Buffer Mode
    #[inline(always)]
