...
///Field `CTSQ` reader - Control Transfer Stage Flag
...
///Field `VALID` reader - USB Request Reception Flag
...
///Field `VALID` writer - USB Request Reception Flag
...
///Field `VBSTS` reader - VBUS Input Status Flag
...
///Field `BRDY` reader - BRDY Interrupt Status Flag
...
///Field `NRDY` reader - NRDY Interrupt Status Flag
...
///Field `BEMP` reader - BEMP Interrupt Status Flag
...
///Field `CTRT` reader - Control Transfer Stage Transition Interrupt Status Flag
...
///Field `CTRT` writer - Control Transfer Stage Transition Interrupt Status Flag
...
///Field `DVST` reader - Device State Transition Interrupt Status Flag
...
///Field `DVST` writer - Device State Transition Interrupt Status Flag
...
///Field `SOFR` reader - Frame Number Refresh Interrupt Status Flag
...
///Field `SOFR` writer - Frame Number Refresh Interrupt Status Flag
...
///Field `RESM` reader - Resume Interrupt Status Flag
...
///Field `RESM` writer - Resume Interrupt Status Flag
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Vbint {
    ///0: No VBUS interrupt occurred on detecting a change in the USBHS_VBUS pin
    _0 = 0,
    ///1: VBUS interrupt occurred on detecting a change in the USBHS_VBUS pin
    _1 = 1,
}
...
///Field `VBINT` reader - VBUS Interrupt Status Flag
...
///Field `VBINT` writer - VBUS Interrupt Status Flag
...
impl R {
    ///Bits 0:2 - Control Transfer Stage Flag
    #[inline(always)]
    pub fn ctsq(&self) -> CtsqR {
        CtsqR::new((self.bits & 7) as u8)
    }
    ///Bit 3 - USB Request Reception Flag
    #[inline(always)]
