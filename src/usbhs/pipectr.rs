...
pub enum Pid {
    ///0: NAK response
    _00 = 0,
    ///1: BUF response (depends on buffer state)
    _01 = 1,
    ///2: STALL response
    _10 = 2,
    ///3: STALL response
...
pub enum Sqset {
    ...
    _0 = 0,
    ///1: Set the expected value for the next transaction to DATA1. This bit is read as 0.
    _1 = 1,
}
...
///Field `CSCLR` writer - CSPLIT Status Clear
...
///Field `INBUFM` reader - Transmit Buffer Monitor Flag
...
impl R {
    ...
    ///Bit 14 - Transmit Buffer Monitor Flag
    #[inline(always)]
...
impl W {
    ...
    ///Bit 13 - CSPLIT Status Clear
    #[inline(always)]
    pub fn csclr(&mut self) -> CsclrW<PipectrSpec> {
        CsclrW::new(self, 13)
    }
}
